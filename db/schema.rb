...
ActiveRecord::Schema.define(version: 2020_11_28_175236) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.string "developer"
    t.bigint "system_requiriment_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["system_requiriment_id"], name: "index_games_on_system_requiriment_id"
  end
  ...
  create_table "system_requiriments", force: :cascade do |t|
    t.string "name"
  ...
  add_foreign_key "games", "system_requiriments"
